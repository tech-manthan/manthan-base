...
import { MnChartElement } from './chart';
...
export const elements = {
  ...
  'mn-chart': MnChartElement,
} as const;

const markers = ['mn-tab', 'mn-tab-panel', 'mn-menu-item', 'mn-menu-label', 'mn-menu-separator', 'mn-column', 'mn-series'];
