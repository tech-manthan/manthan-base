...
export const calendar = slotRecipe({
  slots: {
    ...
    day: [
      ...
      'data-today:font-semibold data-today:not-data-selected:text-accent-11 data-today:after:absolute data-today:after:bottom-1 data-today:after:size-1 data-today:after:rounded-full data-today:after:bg-current',
      'data-selected:border-edge data-selected:bg-accent-9 data-selected:text-accent-contrast data-selected:shadow-btn data-selected:hover:bg-accent-10',
